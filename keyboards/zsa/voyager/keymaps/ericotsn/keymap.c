...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_UNDS, HRM_A,   HRM_S,   HRM_D,   HRM_F,   KC_G,                         KC_H,    HRM_J,   HRM_K,   HRM_L,   HRM_REP, KC_MINS,
    ...
    [EXT] = LAYOUT(
        ...
        _______, _______, _______, PRV_TAB, NXT_TAB, _______,                      KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_DEL,  KC_F12,
        _______, OS_LGUI, OS_LALT, OS_LSFT, OS_LCTL, _______,                      KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, _______,
        _______, OS_UNDO, OS_CUT,  OS_COPY, OS_PSTE, _______,                      _______, KC_ESC,  KC_TAB,  _______, KC_ENT,  _______,
                                                     _______, _______,    _______, _______
    ),
};
// clang-format on
...
const key_override_t *key_overrides[] = {&comm_key_override, &dot_key_override};
